...
ROCK_VELOCITY_INCREASER = 0.05
ANGULAR_VELOCITY_SPEED = 0.1
THRUST_SPEED = 0.2
...
class Ship:
    ...
    def update(self):
        ...
        if self.thrust:
            ...
            self.vel[0] += acc[0] * THRUST_SPEED
            self.vel[1] += acc[1] * THRUST_SPEED
        
        self.vel[0] *= COEFFICIENT_OF_FRICTION
        self.vel[1] *= COEFFICIENT_OF_FRICTION
    ...
    def increment_angle_vel(self):
        self.angle_vel += ANGULAR_VELOCITY_SPEED
...
def rock_spawner():
    if len(rock_group) < rocks:
        ...
        rock_vel = [random.random() * (.6 + ROCK_VELOCITY_INCREASER * score) - (.3 + ROCK_VELOCITY_INCREASER * score), random.random() * (.6 + ROCK_VELOCITY_INCREASER * score) - (.3 + ROCK_VELOCITY_INCREASER * score)]
